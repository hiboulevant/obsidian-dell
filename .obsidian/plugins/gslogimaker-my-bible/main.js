...
var REPORT_ISSUE_URL = "https://github.com/GsLogiMaker/my-bible-obsidian-plugin/issues/new/choose";
var BookNameStyle = /* @__PURE__ */ ((BookNameStyle2) => {
  BookNameStyle2[BookNameStyle2["Display"] = 0] = "Display";
  BookNameStyle2[BookNameStyle2["Abbreviated"] = 1] = "Abbreviated";
  BookNameStyle2[BookNameStyle2["Full"] = 2] = "Full";
  return BookNameStyle2;
})(BookNameStyle || {});
var Version = class {
...
function httpGet(theUrl) {
  const request = (0, import_obsidian.requestUrl)(theUrl).text;
  ...
  try {
    return Promise.race([request, timeout]).catch((e) => {
      throw e;
    });
  } catch (e) {
    throw e;
...
var FormatKeys = class {
};
FormatKeys.translation = /{translation}/g;
FormatKeys.order = /{order}/g;
FormatKeys.book = /{book}/g;
FormatKeys.book_full = /{book_full}/g;
FormatKeys.book_short = /{book_short}/g;
FormatKeys.chapter = /{chapter}/g;
FormatKeys.chapter_name = /{chapter_name}/g;
FormatKeys.chapter_index = /{chapter_index}/g;
FormatKeys.last_chapter = /{last_chapter}/g;
FormatKeys.last_chapter_name = /{last_chapter_name}/g;
FormatKeys.last_chapter_book = /{last_chapter_book}/g;
FormatKeys.next_chapter = /{next_chapter}/g;
FormatKeys.next_chapter_name = /{next_chapter_name}/g;
FormatKeys.next_chapter_book = /{next_chapter_book}/g;
FormatKeys.first_chapter = /{first_chapter}/g;
FormatKeys.first_chapter_name = /{first_chapter_name}/g;
FormatKeys.final_chapter = /{final_chapter}/g;
FormatKeys.final_chapter_name = /{final_chapter_name}/g;
FormatKeys.verses = /{verses}/g;
FormatKeys.book_id = /{book_id}/g;
FormatKeys.verse_text = /{verse_text}/g;
FormatKeys.verse = /{verse}/g;
FormatKeys.index = /{index}/g;
FormatKeys.chapters = /{chapters}/g;
FormatKeys.old_testament = /{old_testament}/g;
FormatKeys.new_testament = /{new_testament}/g;
FormatKeys.apocrypha = /{apocrypha}/g;
var BuildContext = class {
  ...
  abbreviate_book_name(book, delimeter) {
    ...
    return book_id_to_name(book.id).replace(delimeter, "").slice(0, 3);
  }
  format_book_name(book = void 0, style = 0 /* Display */) {
    if (book === void 0) {
      book = this.book;
    }
    ...
    if (style === 1 /* Abbreviated */ || style === 0 /* Display */ && this.plugin.settings.book_name_abbreviated) {
      book_name = this.abbreviate_book_name(book, delim);
    }
    return this.plugin.settings.book_name_format.replace(FormatKeys.translation, String(this.translation)).replace(FormatKeys.book, book_name).replace(
      FormatKeys.order,
      String(this.book_order(book)).padStart(2 * Number(this.plugin.settings.padded_order), "0")
    );
  }
  format_book_name_without_order(book = void 0, casing = void 0, style = 0 /* Display */) {
    if (book === void 0) {
      book = this.book;
    }
    if (casing === void 0) {
  ...
  format_chapter_body() {
    return this.plugin.settings.chapter_body_format.replace(FormatKeys.translation, String(this.translation)).replace(FormatKeys.book, this.format_book_name_without_order(this.book)).replace(FormatKeys.book_full, this.format_book_name_without_order(this.book, void 0, 2 /* Full */)).replace(FormatKeys.book_short, this.format_book_name_without_order(this.book, void 0, 1 /* Abbreviated */)).replace(
      FormatKeys.order,
      String(this.book_order(this.book)).padStart(2 * Number(this.plugin.settings.padded_order), "0")
    ).replace(FormatKeys.chapter, String(this.chapter)).replace(FormatKeys.chapter_name, this.format_chapter_name()).replace(FormatKeys.chapter_index, this.format_chapter_index_name(this.book)).replace(FormatKeys.last_chapter, String(this.prev_chapter)).replace(FormatKeys.last_chapter_name, this.format_chapter_name("last")).replace(FormatKeys.last_chapter_book, this.format_book_name_without_order(this.prev_book)).replace(FormatKeys.next_chapter, String(this.next_chapter)).replace(FormatKeys.next_chapter_name, this.format_chapter_name("next")).replace(FormatKeys.next_chapter_book, this.format_book_name_without_order(this.next_book)).replace(FormatKeys.first_chapter, String(this.book.chapters.first())).replace(FormatKeys.first_chapter_name, this.format_chapter_name("first")).replace(FormatKeys.final_chapter, String(this.book.chapters.last())).replace(FormatKeys.final_chapter_name, this.format_chapter_name("final")).replace(FormatKeys.verses, this.verses_text);
  }
  format_chapter_name(tense = "current", custom_chapter = null) {
    ...
    return format.replace(FormatKeys.translation, String(this.translation)).replace(FormatKeys.book, book_name).replace(
      FormatKeys.order,
  ...
  format_verse_body(custom_text = void 0) {
    ...
    return this.plugin.settings.verse_body_format.replace(FormatKeys.translation, String(this.translation)).replace(FormatKeys.book, book_name).replace(FormatKeys.book_full, this.format_book_name_without_order(this.book, void 0, 2 /* Full */)).replace(FormatKeys.book_short, this.format_book_name_without_order(this.book, void 0, 1 /* Abbreviated */)).replace(FormatKeys.book_id, String(this.book.id)).replace(
      FormatKeys.order,
      String(this.book_order(this.book)).padStart(2 * Number(this.plugin.settings.padded_order), "0")
    ).replace(FormatKeys.chapter, String(this.chapter)).replace(FormatKeys.chapter_name, this.format_chapter_name()).replace(FormatKeys.verse_text, verse_text).replace(FormatKeys.verse, String(this.verse));
  }
  format_chapter_index(book) {
    ...
    return this.plugin.settings.chapter_index_format.replace(FormatKeys.translation, String(this.translation)).replace(FormatKeys.book, book_name).replace(FormatKeys.book_full, this.format_book_name_without_order(book, void 0, 2 /* Full */)).replace(FormatKeys.book_short, this.format_book_name_without_order(book, void 0, 1 /* Abbreviated */)).replace(FormatKeys.order, String(this.book_order(book)).padStart(2 * Number(this.plugin.settings.padded_order), "0")).replace(FormatKeys.index, this.format_index_name()).replace(FormatKeys.chapters, chapter_links).replace(FormatKeys.chapter_index, this.format_chapter_index_name(book));
  }
  format_chapter_index_element(book = void 0, book_name = void 0, chapter = void 0) {
    ...
    return this.plugin.settings.chapter_index_link_format.replace(FormatKeys.translation, String(this.translation)).replace(FormatKeys.book, book_name).replace(FormatKeys.book_full, this.format_book_name_without_order(book, void 0, 2 /* Full */)).replace(FormatKeys.book_short, this.format_book_name_without_order(book, void 0, 1 /* Abbreviated */)).replace(FormatKeys.order, String(this.book_order(book)).padStart(2 * Number(this.plugin.settings.padded_order), "0")).replace(FormatKeys.chapter, String(chapter)).replace(FormatKeys.chapter_name, this.format_chapter_name("custom", chapter));
  }
  format_chapter_index_name(book = void 0) {
    ...
    let book_name = this.format_book_name_without_order(book);
    return this.plugin.settings.chapter_index_name_format.replace(FormatKeys.order, String(this.book_order(book)).padStart(2 * Number(this.plugin.settings.padded_order), "0")).replace(FormatKeys.book, book_name).replace(FormatKeys.book_full, this.format_book_name_without_order(book, void 0, 2 /* Full */)).replace(FormatKeys.book_short, this.format_book_name_without_order(book, void 0, 1 /* Abbreviated */)).replace(FormatKeys.translation, String(this.translation));
  }
  format_index_element(book = void 0) {
    ...
    let link = this.plugin.settings.index_link_format.replace(FormatKeys.translation, String(this.translation)).replace(FormatKeys.book, book_name).replace(FormatKeys.order, String(this.book_order(Number(id))).padStart(2 * Number(this.plugin.settings.padded_order), "0")).replace(FormatKeys.chapter_index, this.format_chapter_index_name(this.books[id])) + "\n";
    return link;
  }
  format_index_name() {
    return this.plugin.settings.index_name_format.replace(FormatKeys.translation, this.translation);
  }
  format_index() {
    let old_t_links = "";
    let new_t_links = "";
    ...
    return this.plugin.settings.index_format.replace(FormatKeys.translation, this.translation).replace(FormatKeys.old_testament, old_t_links).replace(FormatKeys.new_testament, new_t_links).replace(FormatKeys.apocrypha, apocr_links);
  }
  set_book(book) {
    this.book = book;
...
var BollsLifeBibleAPI = class extends BibleAPI {
  ...
  async generate_translation_map(translation) {
    let map = JSON.parse(await httpGet(
...
var BuilderModal = class extends import_obsidian.Modal {
  ...
  renderChapterFormat(setting) {
    setting.clear();
    setting.setName("Body format").addExtraButton(
      (btn) => btn.setIcon("rotate-ccw").setTooltip("Reset value").onClick(async () => {
...
var ErrorModal = class extends import_obsidian.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian.Setting(contentEl).addButton(
      (btn) => btn.setButtonText("Report an issue").setCta().onClick(() => {
        window.open(
          REPORT_ISSUE_URL,
          "_blank"
        );
      ...
      (btn) => btn.setButtonText("Dismiss").onClick(() => {
        this.close();
      })
    );
  }
