...
Float ( ) Nombre décimaux        float
Bool ( ) Booléens                Booléans
Str ("bonjour")
Int (5)
Float (10.7)
Bool (True)
---------- 
Str(5) est converti en une chaîne de caractère:
'5'
À l'inverse on peut à partir d'une chaîne de caractère créer un nombre.
Int(2)
2
